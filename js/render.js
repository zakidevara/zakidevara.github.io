...
function renderPageNotFound(){
  document.getElementById("body-content").innerHTML = "Halaman tidak ditemukan";
}

function renderNeedInternetAccess(){
  document.getElementById("body-content").innerHTML = "Halaman ini tidak dapat diakses secara offline. Refresh halaman ini ketika device anda sudah memiliki akses internet.";
}
